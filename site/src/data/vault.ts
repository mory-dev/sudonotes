    ...
    prompts: [
      {
        ...
        body: "Read the diff and write release notes for people who use the app, not people who wrote it. Group by what changed for them. Skip refactors nobody can see.",
        model: "anthropic/claude-opus-5",
        tags: ["release", "writing"],
      },
      {
        title: "Changelog entry",
        body: "One line per entry, present tense, no adjectives. Each entry ends with the release it shipped in.",
        model: "deepseek/deepseek-v4",
        tags: ["release"],
      },
      {
        title: "Pull request description",
        body: "Three sections: what changed, why, and what a reviewer should look at first. Link the issue. No summary of the diff — the diff is right there.",
        model: "google/gemini-3-pro",
        tags: ["review"],
      },
      {
        title: "Migration note",
        body: "For each breaking change, show the old call and the new one side by side, then say what happens to code that is not migrated.",
        model: "deepseek/deepseek-v4",
        tags: ["release", "docs"],
      },
    ],
